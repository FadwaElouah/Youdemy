...
<body class="bg-[#F5F5DC] text-gray-100">
    <!-- Navigation -->
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="logout.php" class="bg-[#A0522D] text-white hover:bg-[#8B4513] hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2">
