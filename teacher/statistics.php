    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="dashboard-card p-6 rounded-lg">
                ...
                <p class="text-3xl font-bold text-brown-600"><?php echo $total_courses; ?></p>
            </div>
            ...
            <div class="dashboard-card p-6 rounded-lg">
                ...
                <p class="text-3xl font-bold text-brown-600"><?php echo $total_students; ?></p>
            </div>
            ...
            <div class="dashboard-card p-6 rounded-lg">
                ...
                <?php if ($most_popular): ?>
                    <p class="text-lg font-medium text-gray-800"><?php echo htmlspecialchars($most_popular['title']); ?></p>
