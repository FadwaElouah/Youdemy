...
<body class="bg-gray-100">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <?php else: ?>
                        <a href="dashboard.php" class="bg-[#A0522D] text-white hover:bg-[#8B4513]  px-4 py-2 rounded-lg flex items-center space-x-2">Dashboard</a>
                        <a href="logout.php" class="bg-[#A0522D] text-white hover:bg-[#8B4513]  px-4 py-2 rounded-lg flex items-center space-x-2">Logout</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-6xl mx-auto px-4 py-8 bg-[#F5F5DC]">
        <div class="mb-8">
