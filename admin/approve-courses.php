            ...
            <div class="dashboard-card p-6 rounded-lg">
                <table class="min-w-full">
                    <thead class="bg-brown-200">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-brown-800 uppercase tracking-wider">Course Title</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-brown-800 uppercase tracking-wider">Teacher</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-brown-800 uppercase tracking-wider">Category</th>
                    ...
                    <tbody class="bg-white divide-y divide-brown-200">
                        <?php foreach ($unapproved_courses as $course): ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-800"><?php echo htmlspecialchars($course['title']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-800"><?php echo htmlspecialchars($course['teacher_name']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-800"><?php echo htmlspecialchars($course['category_name']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <a href="../pages/course.php?id=<?php echo $course['id']; ?>" class="ml-2 text-brown-600 hover:text-brown-800 flex items-center space-x-2">
